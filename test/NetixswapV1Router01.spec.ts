...
enum RouterVersion {
  NetixswapV1Router01 = 'NetixswapV1Router01',
  NetixswapV1Router02 = 'NetixswapV1Router02'
}

describe('NetixswapV1Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.NetixswapV1Router01]: fixture.router01,
        [RouterVersion.NetixswapV1Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.NetixswapV1Router01]: 101876,
              [RouterVersion.NetixswapV1Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.NetixswapV1Router01]: 138770,
              [RouterVersion.NetixswapV1Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
