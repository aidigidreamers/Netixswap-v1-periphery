...
enum RouterVersion {
  NetixswapRouter01 = 'NetixswapRouter01',
  NetixswapRouter02 = 'NetixswapRouter02'
}

describe('NetixswapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.NetixswapRouter01]: fixture.router01,
        [RouterVersion.NetixswapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.NetixswapRouter01]: 101876,
              [RouterVersion.NetixswapRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.NetixswapRouter01]: 138770,
              [RouterVersion.NetixswapRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
